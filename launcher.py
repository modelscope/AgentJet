...
def parse_args():
    ...
    parser.add_argument(
        '--target',
        type=str,
        default='agentopia.main_verl',
        required=False,
        help='Target script to run (default: agentopia.main_verl)'
    )
...
def main():
    ...
    # if args.with_appworld:
    #     from agentopia.utils.smart_daemon import LaunchCommandWhenAbsent
    #     appworld_path_1 = os.environ.get('APPWORLD_PATH_1')
    #     appworld_python_1 = os.environ.get('APPWORLD_PYTHON_1')
    #     appworld_path_2 = os.environ.get('APPWORLD_PATH_2')
    #     appworld_python_2 = os.environ.get('APPWORLD_PYTHON_2')
    #     if appworld_path_1 and os.path.exists(appworld_path_1):
    #         companion = LaunchCommandWhenAbsent(
    #             full_argument_list=[
    #                 appworld_python_1,
    #                 '-m',
    ...
    #             tag="appworld_env_service"
    #         )
    #         companion.launch(launch_wait_time=1800,success_std_string="Uvicorn running on")
    #     elif appworld_path_2 and os.path.exists(appworld_path_2):
    #         companion = LaunchCommandWhenAbsent(
    #             full_argument_list=[
    #                 appworld_python_2,
    #                 '-m',
