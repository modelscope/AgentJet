...
def can_merge_steps(source_timeline: List[ExtendedMessage], target_timeline: List[ExtendedMessage], debug=False) -> bool:
...
def merge_tracker_timelines(timelines: List[List[ExtendedMessage]]) -> List[List[ExtendedMessage]]:

    def toggle_author(source_timeline: List[ExtendedMessage], target_timeline: List[ExtendedMessage]) -> List[ExtendedMessage]:
