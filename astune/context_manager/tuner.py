...
class ModelTuner(OpenAIChatModel):
    """A model class used by AgentScope-tune for RL training."""
    ...
    def __init__(
        ...
        if enable_thinking is not None:
            ...
            self.generate_kwargs["chat_template_kwargs"]["enable_thinking"] = enable_thinking
        # change the client instance to the provided one
        self.client = openai_async_client
        self.model_registry: dict[str, ChatModelBase] = {}

    def register_model(self, name: str, model: ChatModelBase) -> None:
    ...
    def get_model(self, name: str) -> ChatModelBase:
        """Get the model instance by name.
        ...
        Returns:
            ChatModelBase:
                The model instance corresponding to the provided name.
        """
        return self.model_registry.get(name, self)
