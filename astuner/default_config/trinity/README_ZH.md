...
1. 🎯 **推荐方式**：在大多数情况下，您无需直接调整 Trinity 参数，只需参考并修改上层的 `astuner/default_config/astune_default.yaml` 配置文件即可，
...
3. 🚫 **永远不要编辑**：
   - 永远不要编辑 `astuner/default_config/trinity/trinity_launcher.yaml`
   - 永远不要编辑 `astuner/default_config/trinity/trinity_default.yaml`
