...
1. 🎯 **Recommended Method**: In most cases, you do not need to directly adjust Trinity parameters. Simply refer to and modify the upper-level `astuner/default_config/astune_default.yaml` configuration file, and ASTuner will **automatically** handle parameter mapping for you.
...
3. 🚫 **Never Edit**:
   - Never edit `astuner/default_config/trinity/trinity_launcher.yaml`
   - Never edit `astuner/default_config/trinity/trinity_default.yaml`
