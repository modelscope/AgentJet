...
class FrozenLake:
    ...
    def __init__(self, env_max_steps, agent_max_steps, seed, frozen_lake_size=5, is_slippery=True):
        self.env_max_steps = env_max_steps
        self.agent_max_steps = agent_max_steps
        self.size = frozen_lake_size
        self.is_slippery = is_slippery
        self.seed = seed
        self.p = 0.5  # Probability that a tile is frozen

    async def execute(self, workflow_task: Task, apikey, baseurl) -> WorkflowOutput:
