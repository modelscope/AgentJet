...
TIMELINE_COMPARE_LEVEL = os.getenv("TIMELINE_COMPARE_LEVEL", "text")
MODEL_PATH = os.getenv("MODEL_PATH", "/mnt/data_cpfs/xielipeng.xlp/models/Qwen3-8B-Keep-History")
EXPERIMENT_NAME = os.getenv("EXPERIMENT_NAME", f"appworld_swarm_tlstudy2_{TIMELINE_COMPARE_LEVEL}")
