...
# 新增：数据文件路径配置
TRAIN_DATA_PATH="/mnt/data_cpfs/taoshuchang.tsc/deepresearch/AgentJet/tutorial/example_finworld/data/train_cc423_11171143_tasks.json"
VAL_DATA_PATH="/mnt/data_cpfs/taoshuchang.tsc/deepresearch/AgentJet/tutorial/example_finworld/data/val_30_tasks.json"

# 新增：Reference Answer 文件路径配置（RM Gallery 需要）
TRAIN_REF_ANS_PATH="/mnt/data_cpfs/taoshuchang.tsc/deepresearch/AgentJet/tutorial/example_finworld/data/Reference_ans_DR_11171143_cc.json"
VAL_REF_ANS_PATH="/mnt/data_cpfs/taoshuchang.tsc/deepresearch/AgentJet/tutorial/example_finworld/data/Reference_ans_val.json"
...
if [[ $HOSTNAME == *"-master-"* ]]; then
    ...
    #---------------------------------------------------------------------------
    # 5 & 6. 等待节点和 GPU 就绪 (逻辑保持不变)
    #---------------------------------------------------------------------------
    # ... (此处省略重复的等待逻辑以保持简洁，实际运行时请保留原脚本中的 while 循环) ...
    # [请保留原脚本中 5.等待所有Worker 6.等待GPU 7.等待Dashboard 的完整代码]
