...
# 编译缓存 (防 virtiofs ESTALE). 注: 各 pane 的 source $ENV_SCRIPT 已含这些;
# 此处 CACHE_ENV 仅供 ray head/worker 启动时继承.
CACHE_ENV = {
    "PYTHONNOUSERSITE": "1",
...
#   - source $ENV_SCRIPT 已含编译缓存 + ulimit, 各 pane 无需重复.
# ──────────────────────────────────────────────────────────────────────────────
