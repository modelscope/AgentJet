...
from agentscope_tuner.task_rollout.async_llm_bridge import AgentScopeLlmProxy
from agentscope_tuner.tuner_lib.weight_tuner import as_agentscope_model, as_oai_sdk_model
from agentscope_tuner.utils.magic_mock import SpecialMagicMock

if TYPE_CHECKING:
    from agentscope_tuner import Workflow
    from openai.types.chat.chat_completion import ChatCompletion
    from agentscope_tuner.tuner_lib.weight_tuner.agentscope_tuner import AgentScopeModelTuner
