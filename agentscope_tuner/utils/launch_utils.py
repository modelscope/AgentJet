...
from agentscope_tuner.utils.config_utils import align_parameters
...
def execute_training_process(
    ...
    TRINITY_BOOT_YAML = "agentscope_tuner/default_config/trinity/trinity_launch.yaml"  # THIS FILE IS READ ONLY, and ALWAYS FIXED
