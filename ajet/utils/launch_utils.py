...
def verify_python_env(args, exp_config):
    ...
    if args.backbone == "trinity":
        ...
        if not any([v in verl.__version__ for v in ["0.5.0.post", "0.5.0.dev", "0.7.0.post", "0.8.0.dev"]]):  # you must install via `pip install -e .[verl]` to get every dependency right
