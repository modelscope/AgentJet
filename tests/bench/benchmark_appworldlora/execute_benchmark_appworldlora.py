...
class TestBenchmarkAppworldlora(BenchmarkTestCase):

    def test_01_begin_verl(self):
        # get probe target, so as to get timeout settings
        BACKBONE = "verl"
        TEST_TARGET = "tests/bench/benchmark_appworldlora/benchmark_appworldlora.yaml"
        PROBE_TARGET = "tests/bench/benchmark_appworldlora/benchmark_appworldlora.py->TestProbe"
        ...
        TARGET_NAME = f"benchmark_appworldlora_{BACKBONE}"
