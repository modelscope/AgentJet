...
from agentopia.context_manager.cmt_linear_think import ExtendedMessage, CMTLinear, LinearThinkCMT
from agentopia.context_manager.cmt_foreign_llm import construct_alien_llm_chat_fn
